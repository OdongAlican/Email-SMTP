...
//    }
    ...
    public String[] getTestRecipientsByFileName(String fileName) {
        ...
        fileRecipientsMap.put("Bukoto_data", new String[]{TEST_USER_EMAIL, "jaogon@pridemicrofinance.co.ug"});
        ...
        fileRecipientsMap.put("Hoima_data", new String[]{TEST_USER_EMAIL, "dkatamba@pridemicrofinance.co.ug"});
        fileRecipientsMap.put("Wandegeya_data", new String[]{TEST_USER_EMAIL});
        fileRecipientsMap.put("Kawempe_data", new String[]{TEST_USER_EMAIL, "jaogon@pridemicrofinance.co.ug"});
        ...
        fileRecipientsMap.put("Nansana_data", new String[]{TEST_USER_EMAIL, "dkatamba@pridemicrofinance.co.ug"});
        fileRecipientsMap.put("Kabalagala_data", new String[]{TEST_USER_EMAIL});
        fileRecipientsMap.put("Kyaliwajjala_data", new String[]{TEST_USER_EMAIL, "jaogon@pridemicrofinance.co.ug"});
        ...
        fileRecipientsMap.put("Namayingo_data", new String[]{TEST_USER_EMAIL, "dkatamba@pridemicrofinance.co.ug"});
